...
const SideContent = ({ side_content }) => (
  ...
  >
    ...
    >
      ...
      {/<\/?[a-z0-9]+>/g.test(side_content.sub_heading) ? (
        <Paragraph
          textAlign="start"
          margin="12px 0 0 0"
          dangerouslySetInnerHTML={{ __html: side_content.sub_heading }}
        />
      ) : (
        <Paragraph textAlign="start" margin="12px 0 0 0">
          {side_content.sub_heading}
        </Paragraph>
      )}
    </Div>
  </Div>
    ...
    <Div maxWidth_tablet="1366px" margin_tablet="50px auto">
      ...
      >
        ...
        >
          ...
          >
            {side_content ? (
              <SideContent side_content={side_content} />
            ) : (
              <>
                {image?.src ? (
